  ...
  return (
    <Box as="main" padding={{ base: "4", md: "8" }} maxWidth="5xl" marginX="auto">
            ...
            <Heading size="3xl" marginTop="4">
                {"placeholder"} <Text as="span" fontWeight="500" fontSize="4xl">({"placeholder"})</Text>
            </Heading>
            <Text fontStyle="italic" fontSize="sm" fontWeight="500">
                <Text as="span" fontWeight="800">ADDRESS:</Text> {"placeholder"}
            </Text>
            <Text fontStyle="italic" fontSize="sm" fontWeight="500">
                <Text as="span" fontWeight="800">AUTHOR:</Text> {"placeholder"} {<Text as="span" fontWeight="800">(YOU)</Text>}
            </Text>
            <Text marginTop="4">
                {"placeholder"}
            </Text>
            ...
            {/* {isStringsEqualCaseInsensitive(signerAddr, nftCollection.author) && */}
                <>
                    {/* <Button colorScheme="brand" rightIcon={<AddNftIcon size="24" />} marginLeft="auto" display="flex" justifyContent="center" alignItems="center" onClick={() => {}} isLoading={} loadingText="Minting">
                        Mint
                    </Button> */}
            ...
            <Grid gap="6" templateColumns={{ base: "1fr", sm: "repeat(2, 1fr)", md: "repeat(3, 1fr)" }} marginTop="8">
                {/* {nftCollection.nftsInCollection.map((nft) => { */}
                    ...
                    {/* return ( */}
                        <GridItem key={1} as="figure" width="full" wordBreak="break-word" display="flex" flexDirection="column">
                            <Image alt={`${"placeholder"} NFT - ${"placeholder"}`} src={"https://img.seadn.io/files/736ffa7c3e8ba58917d325774dc55f53.png?fit=max&w=1000"} width="full" fallback={<Skeleton width="full" height="20rem" />} />
                            <Box padding="4" backgroundColor="white" flexGrow="1">
                                <Heading as="figcaption" color="black">{"placeholder"}</Heading>
                                <Text color="blackAlpha.500" fontWeight="700" fontSize="sm" fontStyle="italic">Owner: {"placeholder"}</Text>
                                <Text color="black" marginTop="2">{"placeholder"}</Text>
                            </Box>
